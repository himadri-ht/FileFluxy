...
class Ui_StartWindow(QWidget):
    ...
    def retranslateUi(self, MainWindow) -> None:
        MainWindow.setWindowTitle(QCoreApplication.translate("StartWindow", "Welcome To Fluxy", None))
        self.label.setText(QCoreApplication.translate("StartWindow", "Fluxy", None))
